...
import { Plus, Users, ChevronLeft, ChevronRight, Search, Trash2 } from 'lucide-react';
import { FormLabel } from '../../FormLabel';
import { FormError } from '../../FormError';
import { RelationTag } from '@/types/form-fields';
  ...
  return (
    <div className="w-full">
      ...
      <div className={`
        ...
        ${error ? 'border-red-500 ring-2 ring-red-200 dark:ring-red-900' : 'border-gray-200 dark:border-gray-700'}
        ${disabled ? 'opacity-50' : ''}
      `}>
        {/* Formulario agregar */}
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="bg-gray-50 dark:bg-gray-800/50 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Nombre del Legajo</th>
                        <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Tipo</th>
                        <th className="px-6 py-3 text-right text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Acciones</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                      {paginatedRelations.map((relation, index) => (
                        <tr key={relation.id} className="group hover:bg-blue-50/50 dark:hover:bg-blue-950/20 transition-colors">
