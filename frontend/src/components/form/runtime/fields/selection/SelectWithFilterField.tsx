...
import { inputSizeClasses, getStateClasses, disabledClasses } from '../../field-styles';

interface SelectWithFilterFieldProps {
  id: string;
  label?: string;
  value?: string;
...
export const SelectWithFilterField: React.FC<SelectWithFilterFieldProps> = ({
  id,
  label,
  value = '',
  options,
